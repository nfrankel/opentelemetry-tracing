...
use axum::Json;
use axum_tracing_opentelemetry::{opentelemetry_tracing_layer, response_with_trace_layer, tracing_subscriber_ext};
...
#[tokio::main]
async fn main() {
    tracing_subscriber_ext::init_subscribers().unwrap();
