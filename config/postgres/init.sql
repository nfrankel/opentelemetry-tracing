...
-- Make stock the default schema as I cannot find how to select the schema with tokio_postgres
ALTER DATABASE postgres SET search_path TO stock;
...
INSERT INTO stock.warehouse(id, city, state)
...
INSERT INTO stock.stocklevel(product_id, warehouse_id, quantity)
VALUES (1, 1, 1),
       (1, 2, 2),
       (1, 3, 3),
       (1, 4, 4),
